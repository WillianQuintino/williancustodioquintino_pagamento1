...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF7FC7BD);
  late Color secondary = const Color(0xFF3E9788);
  late Color tertiary = const Color(0xFF00816F);
  late Color alternate = const Color(0xFF006557);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFF6D7A78);
  late Color primaryBackground = const Color(0xFF424F4D);
  late Color secondaryBackground = const Color(0xFF07342E);
  late Color accent1 = const Color(0xFF07689F);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0x4DEE8B60);
